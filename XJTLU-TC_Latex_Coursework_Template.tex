...
\newcommand{\coverPic}{pics/Avatar.png} % Cover picture(Optional)
...
%     Reference    %
%%%%%%%%%%%%%%%%%%%%
% \bibliographystyle{apalike} % APA: apacite | IEEE: ieeetran | Plain: plain
% If you want to use APA7, you need to uncomment the "\usepackage{apacite} % APA Style" in "settings.sty"
